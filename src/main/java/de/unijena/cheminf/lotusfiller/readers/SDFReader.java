                ...
                try{
                    ...
                    if (molecule != null) {
                        ...
                        if(sdfMetaData.containsKey("name")){
                            lotusSourceNaturalProduct.setName(sdfMetaData.get("name").get(0));
                        }

                        if(sdfMetaData.containsKey("synonyms")){
                            lotusSourceNaturalProduct.setSynonyms(sdfMetaData.get("synonyms"));
                        }

                        if(sdfMetaData.containsKey("citations")){
                            lotusSourceNaturalProduct.setCitation(sdfMetaData.get("citations"));
                        }


                        if(!moleculeChecker.isForbiddenMolecule(molecule)){
                            sourceNaturalProductRepository.save(lotusSourceNaturalProduct);
                        }
                    }
