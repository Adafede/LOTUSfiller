...
public class Fragment {
    ...
    public ArrayList<LotusUniqueNaturalProduct> presentInMolecules;
    ...
    public ArrayList<LotusUniqueNaturalProduct> getPresentInMolecules() {
        return presentInMolecules;
    }

    public void setPresentInMolecules(ArrayList<LotusUniqueNaturalProduct> presentInMolecules) {
        this.presentInMolecules = presentInMolecules;
    }

    public void addUniqueNaturalProduct(LotusUniqueNaturalProduct unp){
